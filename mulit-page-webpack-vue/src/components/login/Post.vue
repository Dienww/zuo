<template>
  <div>
    <div class="zuoLoginWarp" @click="close">
    </div>
    <div class="zuoLogin">
      <div class="cha" @click="closePost">x</div>
        ...
        <div class="white">
          ...
          <div>
            <div class="loginText">
              ...
              <input class="txt" type="text" placeholder="确认密码">
            </div>
            <div class="forget">
              <div>
                <img src="" alt="">
              ...
              <div class="pass"><img src="../../assets/zuologin/password.png" alt="">
                <a @click="skipLogin">已有账号，登录</a>
              </div>
            </div>
          </div>
          <button class="btn">注册账号</button>
        </div>
      </div>
    </div>
  </div>
